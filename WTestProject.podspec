#
# Be sure to run `pod lib lint WTestProject.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.test_spec 'Tests' do |test_spec|
    test_spec.source_files = 'WTestProject/Tests/**/*.swift'
    test_spec.resource = 'WTestProject/Tests/Assets/**/*'
  end
  
  # s.resource_bundles = {
  #   'WTestProject' => ['WTestProject/Assets/*.png']
  # }
